...
void *thread_func(void *klllk)
{ //sending thread id as parameter in the form of "threadst" structure which was declared above
...
*/
	...
	fprintf(pipe_gp, "plot '-' u 1:2 title 'client-0' with linespoints\n");
    int cbb = No_C;
    while ((cbb--))
    {
	int r;
